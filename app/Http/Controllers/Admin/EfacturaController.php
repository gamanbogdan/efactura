            ...
            if ($status !== true) {
             throw new \Exception($status);
                ...
                try {
                    ...
                    $path_unzip = $this->storageDestinationPathUnzip.'/'.$time_for_path;
                        ...
                        while (false !== ($fileNameXML = readdir($dir_data_anaf))) {
                            ...
                            if(in_array($ext, array("xml")) && $prefix_xml!="semnatura_") {
                                ...
                                if (isset($invoice_details_xml['Instructiuni_de_plata'])) { 
                                    ...
                                    $paymentMeansModel->Codul_tipului_instrumentului_de_plata = $invoice_details_xml['Instructiuni_de_plata']['Codul_tipului_instrumentului_de_plata'];
                                    $paymentMeansModel->Nota_privind_instrumentul_de_plata = $invoice_details_xml['Instructiuni_de_plata']['Nota_privind_instrumentul_de_plata'];
                                    $paymentMeansModel->Aviz_de_plata = $invoice_details_xml['Instructiuni_de_plata']['Aviz_de_plata'];
                                    $paymentMeansModel->Numarul_contului_principal_al_cardului_de_plata = $invoice_details_xml['Instructiuni_de_plata']['Numarul_contului_principal_al_cardului_de_plata'];
                                    $paymentMeansModel->Numele_detinatorului_cardului_de_plata = $invoice_details_xml['Instructiuni_de_plata']['Numele_detinatorului_cardului_de_plata'];
                                    $paymentMeansModel->Identificatorul_contului_de_plata = $invoice_details_xml['Instructiuni_de_plata']['Identificatorul_contului_de_plata'];
                                    $paymentMeansModel->Numele_contului_de_plata = $invoice_details_xml['Instructiuni_de_plata']['Numele_contului_de_plata'];
                                    $paymentMeansModel->Identificatorul_furnizorului_de_servicii_de_plata = $invoice_details_xml['Instructiuni_de_plata']['Identificatorul_furnizorului_de_servicii_de_plata'];
                                    $paymentMeansModel->Debitare_directa_Identificatorul_referintei_mandatului = $invoice_details_xml['Instructiuni_de_plata']['Debitare_directa']['Identificatorul_referintei_mandatului'];
                                    $paymentMeansModel->Debitare_directa_Identificatorul_contului_debitat = $invoice_details_xml['Instructiuni_de_plata']['Debitare_directa']['Identificatorul_contului_debitat'];
